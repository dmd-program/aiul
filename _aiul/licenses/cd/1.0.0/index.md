---
layout: aiul
permalink: /licenses/cd/1.0.0/
redirect_from:
  - /licenses/aiul-cd.html
  - /licenses/cd.html
version: 1.0.0
released: 2025-12-09
license_id: cd
...
# AIUL-CD v1.0.0 - Conceptual Development
...
- **Code:** CD
- **Full Name:** Conceptual Development
- **Short Description:** AI tools may be used for research and ideation, but the final work must be entirely student-generated.
- **Syllabus Text:** "you may use AI tools for research and idea generation, but the final work must be entirely your own. You must document any AI tools used in your process."
...
- May use AI tools only for research, ideation, and concept development
- The final work must be entirely created by the student without AI generation
- Must document which AI tools were used and how they contributed to the ideation process
