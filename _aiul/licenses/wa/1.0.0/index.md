---
layout: aiul
permalink: /licenses/wa/1.0.0/
redirect_from:
  - /licenses/aiul-wa.html
  - /licenses/wa.html
version: 1.0.0
released: 2025-12-09
license_id: wa
...
- **Code:** WA
- **Full Name:** With Approval
- **Short Description:** Limited AI assistance is permitted only with instructor pre-approval.
- **Syllabus Text:** "limited AI assistance is permitted only with instructor pre-approval. If you wish to use any AI tools, you must request permission in advance and document how they will be used."
...
- Must request and receive explicit permission before using AI tools
- Must document which AI tools were used and how they were integrated into the work
- AI usage should support rather than replace the student's work
- Must follow any additional guidelines specified in the approval
...
Use this license for assignments that are typically expected to be completed without AI assistance, but where exceptions may be appropriate for specific students or circumstances.
