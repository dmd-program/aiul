---
layout: aiul
permalink: /licenses/dp/1.0.0/
redirect_from:
  - /licenses/aiul-dp.html
  - /licenses/dp.html
version: 1.0.0
released: 2025-12-09
license_id: dp
...
# AIUL-DP v1.0.0 - Directed Production
...
- **Code:** DP
- **Full Name:** Directed Production
- **Short Description:** AI-assisted creation is permitted with clear direction and modification from the student.
- **Syllabus Text:** "you may use AI-assisted creation with clear direction and modification from you. The concept, direction, and post-processing should demonstrate your creative input."
...
- May use AI tools to generate content under their direction
- Must provide clear creative direction to the AI tools
- Must apply post-processing and refinement to AI outputs
- Must document their prompts, direction process, and post-processing decisions
...
Use this license for visual arts, creative writing, and design assignments where AI can be used as a production tool guided by the student's creative vision.
